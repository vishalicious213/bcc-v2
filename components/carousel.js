    ...
    return (
        <div className='body'>
            ...
            <Slider {...settings}>
                ...
                <div>
                    <img src='/carousel-images/carousel-14.jpg' alt='Breast Cancer Comfort comfort basket' />
                </div>
                <div>
                    <img src='/carousel-images/carousel-15.jpg' alt='Breast Cancer Comfort comfort basket' />
                </div>
                <div>
